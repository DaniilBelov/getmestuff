<div data-2100="top: -200px;" data-2200="top: 10px;" class="flex center slide-header pos-r">
...
<div class="text flex vertical w8 m-auto" data-2000="top: -100px;" data-2200="top: 190px;" data-2700="opacity: 1;">
    <div data-2300="opacity: 0;" data-2500="opacity: 1;" class="w45 self-start">
        <p>After all the hard work that has been put into the project and organization of the strategy, we are finally ready to launch GetMeStuff worldwide. With hundreds of users from all over the world joining every day and publishing their wishes, we take care of each and every one to make their lives just a bit happier. We are challenged by the great mission – to unite and inspire people for a mutual support.</p>
    </div>
    <img itemprop="image" alt="Rocket flying into Space" class="main-image" src="{{ asset('images/timeline/launch.png') }}">
