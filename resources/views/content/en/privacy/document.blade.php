...
<div class="text">
    ...
    <section class="section3 vertical">
        ...
        <ul class="list dash">
            ...
            <li>
                <p>Use mailing address to deliver a product.</p>
            </li>
            <li>
    ...
    <section class="section8 vertical">
        ...
        <p>You will be notified of any Privacy Policy changes on our Privacy Policy Page (this page).</p>
    </section>
    <section class="section9 vertical">
        <h4>How we handle Do Not Track signals</h4>
    ...
    <section class="section12 vertical">
        ...
        <p>We will notify you via email within 2 business days.</p>
        <p>We will notify the users via in-site notification within 2 business days.</p>
        <p>We also agree to the Individual Redress Principle which requires that individuals have the right to legally pursue enforceable rights against data collectors and processors who fail to adhere to the law. This principle requires not only that individuals have enforceable rights against data users, but also that individuals have recourse to courts or government agencies to investigate and/or prosecute non-compliance by data processors.</p>
    </section>
    <section class="section13 vertical">
        <h4>CAN SPAM Act</h4>
        ...
        <p>If at any time you would like to unsubscribe from receiving future emails, you can email us at support@getmesuff.net</p>
