                                ...
                                <tr>
                                    <td style="font-size: 11px; color: #666;" align="center">
                                        <p style="margin: 0 0 5px;">
                                            <a style="color: #666; text-decoration: none;" href="{{ url('terms') }}">Условия использования</a> · 
                                            <a style="color: #666; text-decoration: none;" href="{{ url('privacy') }}">Политика конфидициальности</a> · 
                                            <a style="color: #666; text-decoration: none;" href="{{ url('faq') }}">Вопросы</a>
                                        </p>
